    ...
    <div className="grid justify-center max-w-md mx-auto">
      ...
      <form className="bg-white rounded-2xl p-6 -mt-24 relative z-10 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
        ...
        <div className="relative flex items-center">
          <input name="email" type="text" required onChange={handleEmailChange} className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
        ...
        <div className="mt-6">
          <div className="relative flex items-center">
            <input name="password" type="password" required onChange={handlePasswordChange} className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
        ...
        <div className="mt-12">
          <button type="button" onClick={handleSubmitLogin} className="w-full py-2.5 px-4 text-sm font-semibold tracking-wider rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
            Sign in
          </button>
